...
def train(train_data,train_label,valid_data,valid_label,train_n,valid_n,IMAGE_HEIGHT,IMAGE_WIDTH,learning_rate,num_classes,epoch,EARLY_STOP_PATIENCE,batch_size=64,keep_prob=0.8,
           arch_model=None,checkpoint_exclude_scopes="Logits_out", save_path=None):
    ...
    elif arch_model=='arch_resnet_v2_50_rnn_attention':
        net=net.arch_resnet_v2_50_rnn_attention(X, num_classes, k_prob, is_training)
    elif arch_model=='resnet_v2_50_rnn':
        net=net.arch_resnet_v2_50_rnn(X, num_classes, k_prob, is_training)
...
if __name__ == '__main__':
    ...
    train(train_data,train_label,valid_data,valid_label,train_n,valid_n,IMAGE_HEIGHT,IMAGE_WIDTH,learning_rate,num_classes,epoch,batch_size,keep_prob,
          arch_model, checkpoint_exclude_scopes, save_path=None)
